...
function playDailyMotivationAudio(dayNumber, patientName = '', onEndCallback = null) {
    ...
    // تشغيل الصوت البشري الحقيقي المعتمد في المنظومة فوراً بدون أي تأخير أو استدعاءات شبكية
    if (typeof playStationAudio === 'function') {
        playStationAudio('motivation', onEndCallback, 'recovery');
...
// // شبكة نقاط الألم التشريحية الافتراضية المحدثة والمعتمدة طبقاً للمعايرة الدقيقة للمستخدم
const DEFAULT_FRONT_POINTS = [
    { id: "shoulder_right_f", region: "shoulder", title: "مفصل الكتف الأيمن", keywords: "كتف يمين, كفة مدورة, تجمد كتف, رفع ذراع", x: 28, y: 23 },
    { id: "shoulder_left_f", region: "shoulder", title: "مفصل الكتف الأيسر", keywords: "كتف يسار, كفة مدورة, تجمد كتف", x: 72, y: 23 },
    { id: "elbow_right_f", region: "elbow", title: "مفصل الكوع الأيمن", keywords: "كوع يمين, مرفق تنس, ساعد", x: 26, y: 40 },
    { id: "elbow_left_f", region: "elbow", title: "مفصل الكوع الأيسر", keywords: "كوع يسار, مرفق تنس, ساعد", x: 75, y: 40 },
    { id: "wrist_right_f", region: "wrist", title: "الرسغ واليد اليمنى", keywords: "رسغ يمين, يد يمين, نفق رسغي, تنميل أصابع, إبهام", x: 20, y: 53 },
    { id: "wrist_left_f", region: "wrist", title: "الرسغ واليد اليسرى", keywords: "رسغ يسار, يد يسار, نفق رسغي, تنميل أصابع", x: 82, y: 52 },
    { id: "hip_right_f", region: "hip", title: "مفصل الورك الأيمن", keywords: "ورك يمين, مفصل الفخذ", x: 34, y: 54 },
    { id: "hip_left_f", region: "hip", title: "مفصل الورك الأيسر", keywords: "ورك يسار, مفصل الفخذ", x: 66, y: 54 },
    { id: "knee_right_f", region: "knee", title: "مفصل الركبة اليمنى والصابونة", keywords: "ركبة يمين, صابونة, احتكاك ركبة, طقطقة ركبة", x: 41, y: 74 },
    { id: "knee_left_f", region: "knee", title: "مفصل الركبة اليسرى والصابونة", keywords: "ركبة يسار, صابونة, احتكاك ركبة", x: 61, y: 74 },
    { id: "ankle_right_f", region: "ankle", title: "الكاحل ومفصل القدم الأيمن", keywords: "كاحل يمين, قدم يمين, مسمار كعب, لفافة أخمصية", x: 40, y: 92 },
    { id: "ankle_left_f", region: "ankle", title: "الكاحل ومفصل القدم الأيسر", keywords: "كاحل يسار, قدم يسار, مسمار كعب", x: 61, y: 93 }
];

const DEFAULT_BACK_POINTS = [
    { id: "cervical_back", region: "cervical", title: "الفقرات العنقية (الرقبة الخلفية)", keywords: "ديسك رقبة, تشنج رقبة, فقرات عنقية, تصلب رقبة", x: 50, y: 18 },
    { id: "trapezius_right", region: "shoulder", title: "عضلة شبه المنحرفة وأعلى الكتف الأيمن", keywords: "كتف يمين, أعلى الكتف, مفصل الكتف, كفة مدورة, أبهر يمين, عقدة عضلية, شبه منحرفة", x: 39, y: 20 },
    { id: "trapezius_left", region: "shoulder", title: "عضلة شبه المنحرفة وأعلى الكتف الأيسر", keywords: "كتف يسار, أعلى الكتف, مفصل الكتف, كفة مدورة, أبهر يسار, عقدة عضلية, شبه منحرفة", x: 62, y: 20 },
    { id: "scapula_right", region: "shoulder", title: "لوح الكتف الأيمن", keywords: "لوح كتف يمين, خلف الظهر, كفة مدورة", x: 39, y: 30 },
    { id: "scapula_left", region: "shoulder", title: "لوح الكتف الأيسر", keywords: "لوح كتف يسار, خلف الظهر, كفة مدورة", x: 62, y: 30 },
    { id: "thoracic_spine", region: "thoracic", title: "الفقرات الصدرية وأعلى الظهر", keywords: "أعلى الظهر, فقرات صدرية, بين الكتفين", x: 50, y: 32 },
    ...
    { id: "sacroiliac_right", region: "lumbar", title: "المفصل العجزي الحوضي الأيمن", keywords: "مفصل عجزي يمين, عجز, حوض خلفي", x: 45, y: 52 },
    { id: "sacroiliac_left", region: "lumbar", title: "المفصل العجزي الحوضي الأيسر", keywords: "مفصل عجزي يسار, عجز, حوض خلفي", x: 58, y: 52 },
    { id: "gluteal_right", region: "lumbar", title: "عضلات الأرداف ومسار عرق النسا الأيمن", keywords: "عرق النسا يمين, كمثرية, تنميل فخذ يمين, سياتيكا", x: 40, y: 48 },
    { id: "gluteal_left", region: "lumbar", title: "عضلات الأرداف ومسار عرق النسا الأيسر", keywords: "عرق النسا يسار, كمثرية, تنميل فخذ يسار, سياتيكا", x: 64, y: 47 },
    { id: "achilles_calf", region: "ankle", title: "عضلة السمانة ووتر أكيليس اليمنى", keywords: "سمانة يمين, وتر أكيليس يمين, بطة الرجل يمين, كعب يمين", x: 61, y: 84 },
    { id: "point_37515", region: "ankle", title: "عضلة السمانة ووتر أكيليس اليسرى", keywords: "سمانة يسار, وتر أكيليس يسار, بطة الرجل يسار, كعب يسار", x: 40, y: 83 }
];

// تحديث التخزين المحلي فورياً بهذه الإحداثيات المعتمدة
try {
    localStorage.setItem('custom_front_points', JSON.stringify(DEFAULT_FRONT_POINTS));
    localStorage.setItem('custom_back_points', JSON.stringify(DEFAULT_BACK_POINTS));
} catch(e) {}
...
// الاستماع الفوري لتعديلات أداة المعايرة عند الحفظ لتحديث المجسم مباشرة دون إعادة تحميل الصفحة
window.addEventListener('storage', (e) => {
    if (e.key === 'custom_front_points' || e.key === 'custom_back_points') {
        const frontCont = document.getElementById('front-anatomy-container');
        const isFront = frontCont && frontCont.style.display !== 'none';
        if (typeof renderAnatomyPoints === 'function') {
            if (isFront) {
...
function renderAnatomyPoints(containerId, points) {
    ...
    // صمام أمان فوري: ربط استكمال تحميل صورة المجسم بإعادة التموضع الدقيق
    const img = container.querySelector('img.skeleton-img');
    if (img && !img._anatomyLoadBound) {
        img._anatomyLoadBound = true;
        if (!img.complete) {
            img.addEventListener('load', () => {
                renderAnatomyPoints(containerId, points);
            }, { once: true });
        }
    }
}
...
async function restoreActiveSessionState() {
    ...
    // إذا كان المريض مسجلاً دخوله بحسابه الخاص ولم يُحدد مريض في الرابط، حسابه هو المعتمد قطعاً
    if (!savedPatientId && authP && (authP.patientId || authP.id)) {
        savedPatientId = authP.patientId || authP.id;
    }

    if (!savedPatientId) {
        savedPatientId = sessionStorage.getItem('scp_active_patient_id')
            || localStorage.getItem('smart_current_patient_id')
            || localStorage.getItem('smart_last_active_patient_id');
    }
    ...
    // إذا تم فتح جلسة محددة عبر الرابط لمريض محدد أو تسجيل دخول: عزل الجلسة فوراً ومنع تسرب بيانات من مريض آخر
    const targetSessionPid = queryPid || (authP && (authP.patientId || authP.id));
    if (targetSessionPid) {
        if (activePatient && activePatient.patientId !== targetSessionPid && activePatient.id !== targetSessionPid) {
            activePatient = null;
    ...
    // استرجاع تقرير الجلسة الحالية من التخزين المحلي فقط إذا كان يخص المريض الحالي نفسه
    if (!currentAssessmentData && !queryPid) {
        try {
            ...
            if (rawAss) {
                ...
                const currentExpectedPid = (authP && (authP.patientId || authP.id)) || savedPatientId;
                if (parsedAss) {
                    if (!currentExpectedPid || !parsedAss.patientId || parsedAss.patientId === currentExpectedPid) {
                        currentAssessmentData = parsedAss;
                        if (parsedAss.patientId && !savedPatientId) {
                            savedPatientId = parsedAss.patientId;
                        }
                    } else {
                        // التقرير المخزن في الكاش يخص مريضاً آخر أو جلسة سابقة — تفريغه لسلامة العزل
...
function sendWhatsAppDiagnosticReport() {
    ...
    if (data.isSpecializedConsultation || activePointSpec) {
        ...
        const specName = (specType === 'stroke') ? 'تأهيل ما بعد الجلطات والضعف الحركي' :
                         ...
                         'تقوس وانحراف العمود الفقري (الجنف Scoliosis)';
        let sText = `السلام عليكم دكتور جمال قبها،\n`;
        sText += `أنا المراجع: ${name}\n`;
        if (data.patientPhone || clinicalDialogueState?.patientPhone) sText += `الهاتف: ${data.patientPhone || clinicalDialogueState.patientPhone}\n`;
        sText += `نوع الحالة الخاصة: ${specName}\n`;
        if (data.bmiInfo) sText += `مؤشر الكتلة (BMI): ${data.bmiInfo.value} (${data.bmiInfo.status})\n`;
        if (data.notes || data.userNotes) sText += `الأعراض والبيانات المسجلة: ${data.notes || data.userNotes}\n`;
        sText += `\nأرغب بترتيب موعد كشف سريري مباشر / استفسار عن إمكانية الزيارة المنزلية والتأهيل اليدوي في منصة «وداعاً للألم».`;
        const enc = encodeURIComponent(sText);
        window.open(`https://wa.me/${CLINIC_WHATSAPP_NUMBER}?text=${enc}`, '_blank');
        return;
    }
...
function renderSpecializedClinicalReportStep3(data, reportContainer) {
    ...
    let specIcon = '🧠';
    let specCategory = 'تأهيل عصبي حركي متقدم';
    let specColor = '#38bdf8';
    let specAdvice = 'حالات ما بعد الجلطات وضعف الحركة تحتاج تدخلاً سريرياً يدوياً مباشراً لإعادة تدريب المسارات العصبية، موازنة المشي، وتليين التصلب العضلي التشنجي. تطبيق تمارين عشوائية دون إشراف مباشر قد يؤدي لاختلال حركي أو السقوط.';
    let specInterventionDesc = `${specCategory} - تتطلب تقييماً وتأهيلاً عصبياً حركياً متقدماً بإشراف المعالج جمال قبها لإعادة تحفيز التوصيل العصبي العضلي (Neuroplasticity)، تدريب التوازن وميكانيكا المشي، وتليين التصلب العضلي التشنجي (Spasticity).`;
    let specKeyPoints = [
        { icon: '⚡', title: 'إعادة تحفيز التوصيل العصبي العضلي', desc: 'تنشيط الإشارات العصبية الواصلة من المخ إلى العضلات المتأثرة لتحفيز التعافي العصبي التكيفي (Neuroplasticity).' },
        { icon: '🤲', title: 'تليين التصلب والتشنج التيبسي (Spasticity)', desc: 'تقنيات يدوية متخصصة لتحرير تشنج الأوتار والأصابع ومنع تشوه المفصل ومحدودية حركته.' },
        { icon: '🚶‍♂️', title: 'إعادة تدريب نمط المشي والتوازن الآمن', desc: 'تصحيح مركز ثقل الجسم وتدريب نقل الوزن بين الساقين لمنع التعثر والسقوط.' },
        { icon: '🏡', title: 'إمكانية الرعاية والزيارات المنزلية', desc: 'تتوفر خدمة الزيارات المنزلية المتكاملة في عمان والزرقاء للحالات التي يصعب نقلها إلى العيادة.' }
    ];

    if (specialty === 'foot_drop') {
        specTitle = 'سقوط القدم وصعوبة رفع المشط (Foot Drop)';
        specEnTitle = 'Foot Drop & Peroneal Nerve Neuropathy';
        specIcon = '🦶';
        specCategory = 'اعتلال عصبي حركي للقدم وميكانيكا المشي';
        specColor = '#f59e0b';
        specAdvice = 'سقوط القدم يستوجب كشفاً دقيقاً لسلامة العصب الشظوي وجذور الفقرات القطنية (L5) لتحديد إمكانية استعادة رفع المشط بالتقويم اليدوي والتحفيز العصبي المباشر.';
        specInterventionDesc = `${specCategory} - تتطلب كشفاً وتقويماً يدوياً مباشراً لتحرير الانضغاط الجذري للفقرات القطنية (L5) ومسار العصب الشظوي، واستعادة رفع مشط القدم وحماية أوتار الكاحل وميكانيكا المشي.`;
        specKeyPoints = [
            { icon: '🔍', title: 'تحرير انضغاط العصب القطني الخامس (L5)', desc: 'الكشف اليدوي لتحرير الضغط عن الجذر العصبي المغذي للعضلة الظنبوبية الأمامية المسؤولة عن رفع مشط القدم.' },
            { icon: '⚡', title: 'تحفيز العصب الشظوي (Peroneal Nerve)', desc: 'إعادة استثارة المسار العصبي حول رأس عظم الشظية وتنشيط رافعات أصابع القدم.' },
            { icon: '📐', title: 'تقويم ميكانيكا الكاحل ومنع قصر وتر أكيليس', desc: 'حماية مفصل الكاحل من التيبس والحفاظ على المدى الحركي الكامل أثناء المشي.' },
            { icon: '🦿', title: 'تقييم وتوجيه دعامات المشط (AFO)', desc: 'تحديد الحاجة لدعامة مؤقتة لتأمين المشي ومنع السقوط لحين استعادة التحكم العضلي.' }
        ];
    } else if (specialty === 'scoliosis') {
        specTitle = 'تقوس وانحراف العمود الفقري (الجنف Scoliosis)';
        specEnTitle = 'Spinal Scoliosis & 3D Postural Alignment';
        specIcon = '📐';
        specCategory = 'اعوجاج وتقويم هيكلي ثلاثي الأبعاد';
        specColor = '#10b981';
        specAdvice = 'الجنف انحراف ثلاثي الأبعاد لا تناسبه التمارين المنزلية المتناظرة نهائياً. يتطلب كشفاً يدوياً عيانياً لمستوى الكتفين والحوض وإجراء تقويم يدوي مخصص لإعادة توازن الأحمال الميكانيكية.';
        specInterventionDesc = `${specCategory} - تتطلب تقويماً يدوياً ثلاثي الأبعاد بإشراف المعالج جمال قبها لإعادة اصطفاف الفقرات، موازنة أحمال الكتفين والحوض، وتخفيف الشد العضلي غير المتناظر.`;
        specKeyPoints = [
            { icon: '📐', title: 'تقييم زاوية الانحراف (زاوية كوب Cobb Angle)', desc: 'فحص سريري دقيق لدرجة الالتفاف الدواراني للفقرات ومقارنتها بصور الأشعة السينية.' },
            { icon: '⚖️', title: 'موازنة عضلات التحدب والتقعر (Asymmetric Alignment)', desc: 'تقنيات كايروبراكتيك غير متناظرة لإطالة الجانب المنكمش وتقوية الجانب المجهد واستعادة توازن الحوض.' },
            { icon: '🚫', title: 'منع التمارين العشوائية الضارة', desc: 'تجنب تمارين الظهر العامة التي قد تضغط على جهة التحدب وتزيد من حدة اعوجاج العمود الفقري.' },
            { icon: '🫁', title: 'تفريغ الضغط عن القفص الصدري والتنفس', desc: 'تحسين الميكانيكا الحركية للأضلاع وتخفيف إجهاد التنفس وآلام الظهر المصاحبة للانحراف.' }
        ];
    }
    ...
    const pHeight = vitals.height ? `${vitals.height} سم` : 'غير محدد';
    const pBmi = vitals.bmiInfo?.value ? `${vitals.bmiInfo.value} (${vitals.bmiInfo.status})` : (vitals.weight && vitals.height ? `${(vitals.weight / Math.pow(vitals.height/100, 2)).toFixed(1)}` : 'غير محدد');
    const notes = data.notes || (clinicalDialogueState.collectedSymptoms && clinicalDialogueState.collectedSymptoms.length > 0 ? clinicalDialogueState.collectedSymptoms.join(' - ') : 'استشارة سريرية متقدمة');

    const waText = encodeURIComponent(
`السلام عليكم دكتور جمال قبها،
أنا المراجع: ${pName}
العمر: ${pAge} | الهاتف: ${pPhone}
نوع الحالة الخاصة: ${specTitle}
المؤشرات الحيوية: وزن ${pWeight} / طول ${pHeight} / كتلة الجسم: ${pBmi}
تفاصيل الأعراض والشكوى: ${notes}
...
أرغب بترتيب موعد كشف سريري مباشر / استفسار عن إمكانية الزيارة المنزلية والتأهيل اليدوي في منصة «وداعاً للألم».`
    ...
    reportContainer.innerHTML = `
        <div class="clinical-report-printable" style="background: linear-gradient(135deg, #0d1522 0%, #152238 100%); border-radius: 16px; padding: 28px; border: 2px solid var(--primary-gold); box-shadow: 0 12px 40px rgba(0,0,0,0.6); margin-bottom: 30px; animation: fadeIn 0.4s ease;">
            
            <!-- 1. الترويسة الطبية الملكية -->
            <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid var(--primary-gold); padding-bottom: 20px; margin-bottom: 22px; flex-wrap: wrap; gap: 15px;">
                <div style="display: flex; align-items: center; gap: 16px;">
                    <img src="assets/logo.png" alt="شعار وداعاً للألم" style="height: 68px; width: 68px; border-radius: 50%; border: 2px solid var(--primary-gold); background: #000; box-shadow: 0 4px 15px rgba(212,175,55,0.3);">
                    <div>
                        <h1 style="color: #ffffff; margin: 0 0 4px 0; font-size: 1.5em; font-weight: 800;">التقرير السريري وبطاقة التحويل للتأهيل المباشر</h1>
                        <div style="color: var(--primary-gold); font-size: 0.95em; font-weight: bold;">
                            المراجع: <span style="color: #38bdf8; font-weight: 900;">${pName}</span> • «وداعاً للألم» للتأهيل والكايروبراكتيك
                        </div>
                        <div style="color: #94a3b8; font-size: 0.82em; margin-top: 2px;">رقم الملف: <span style="color: #e2e8f0; font-weight: bold;">${reportId}</span> | التاريخ: ${currentDate}</div>
                    </div>
                </div>
                
                <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                    <a href="${waUrl}" target="_blank" class="btn-header no-print btn-whatsapp-cta" style="padding: 10px 20px; font-weight: bold; font-size: 0.9em; border-radius: 10px; display: inline-flex; align-items: gap: 8px; text-decoration: none; box-shadow: 0 4px 20px rgba(37, 211, 102, 0.4);">
                        <span>💬</span> إرسال للمعالج واتساب
                    </a>
                    <button type="button" onclick="window.print()" class="btn-header no-print" style="background: #3b82f6; color: #fff; border: 1.5px solid #60a5fa; padding: 10px 18px; font-weight: bold; font-size: 0.9em; border-radius: 10px; cursor: pointer;">
                        🖨️ طباعة / PDF
                    </button>
                </div>
            </div>

            <!-- بطاقة تعريف المريض والمؤشرات -->
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(190px, 1fr)); gap: 12px; background: rgba(15, 23, 42, 0.85); border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 12px; padding: 16px; margin-bottom: 22px; color: #cbd5e1; font-size: 0.9em;">
                <div>👤 <strong>المراجع:</strong> <span style="color: #fff; font-weight: bold;">${pName}</span></div>
                <div>📱 <strong>الهاتف المعتمد:</strong> <span style="color: #6ee7b7; direction: ltr; display: inline-block; font-weight: bold;">${pPhone}</span></div>
                <div>🎂 <strong>العمر:</strong> <span style="color: #fff;">${pAge}</span></div>
                <div>⚖️ <strong>الوزن:</strong> <span style="color: #fff;">${pWeight}</span></div>
                <div>📏 <strong>الطول:</strong> <span style="color: #fff;">${pHeight}</span></div>
                <div>📊 <strong>مؤشر الكتلة:</strong> <span style="color: #fef08a;">${pBmi}</span></div>
            </div>

            <!-- 2. بطاقة التشخيص والتصنيف السريري المتقدم -->
            <div style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.98) 0%, rgba(30, 41, 59, 0.9) 100%); border-radius: 14px; padding: 24px; border: 2px solid ${specColor}; margin-bottom: 22px; box-shadow: 0 8px 30px rgba(0,0,0,0.5);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; flex-wrap: wrap; gap: 10px;">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <span style="font-size: 2.4em; background: rgba(0,0,0,0.3); border: 1.5px solid ${specColor}; border-radius: 14px; padding: 8px;">${specIcon}</span>
                        <div>
                            <div style="color: #94a3b8; font-size: 0.86em; font-weight: bold;">التصنيف السريري المتقدم:</div>
                            <h2 style="color: #ffffff; margin: 4px 0 2px 0; font-size: 1.35em; font-weight: 900;">${specTitle}</h2>
                            <div style="color: ${specColor}; font-size: 0.85em; font-weight: bold;">${specEnTitle}</div>
                        </div>
                    </div>
                    <span style="background: rgba(16, 185, 129, 0.2); border: 1.5px solid #10b981; color: #6ee7b7; padding: 6px 16px; border-radius: 25px; font-weight: 800; font-size: 0.92em;">
                        🌟 حالة سريرية خاصة معتمدة
                    </span>
                </div>
                <div style="color: #cbd5e1; font-size: 0.92em; line-height: 1.7; background: rgba(0,0,0,0.25); border-radius: 10px; padding: 14px 16px; border: 1px solid rgba(255,255,255,0.08);">
                    📌 <strong>طبيعة التدخل الموصى به:</strong> ${specInterventionDesc}
                </div>
            </div>

            <!-- 3. ملخص بيانات وأعراض الحالة المستلمة -->
            <div style="background: rgba(15, 23, 42, 0.85); border: 1.5px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 18px 20px; margin-bottom: 22px;">
                <h4 style="color: var(--primary-gold); margin: 0 0 10px 0; font-size: 1.05em; display: flex; align-items: center; gap: 8px;">
                    <span>📝</span> ملخص الأعراض والبيانات المسجلة في الاستجواب السريري:
                </h4>
                <div style="color: #e2e8f0; font-size: 0.92em; line-height: 1.7; background: rgba(0,0,0,0.3); border-radius: 8px; padding: 12px 14px; border-right: 4px solid var(--primary-gold);">
                    ${notes}
                </div>
            </div>

            <!-- 4. تنبيه الأمان السريري الحاسم -->
            <div style="background: rgba(234, 179, 8, 0.12); border: 2px solid #eab308; border-radius: 14px; padding: 18px 20px; margin-bottom: 24px;">
                <div style="color: #fef08a; font-weight: bold; font-size: 1em; margin-bottom: 8px; display: flex; align-items: center; gap: 8px;">
                    <span>⚠️</span> توجيه أمان طبي وسريري حاسم:
                </div>
                <p style="color: #f1f5f9; font-size: 0.92em; line-height: 1.7; margin: 0;">
                    ${specAdvice}
                </p>
            </div>

            <!-- 5. محاور الخطة السريرية المقترحة مع المعالج جمال قبها -->
            <div style="background: rgba(15, 23, 42, 0.95); border: 1.5px solid rgba(56, 189, 248, 0.35); border-radius: 14px; padding: 20px; margin-bottom: 25px;">
                <h4 style="color: #38bdf8; margin: 0 0 14px 0; font-size: 1.1em; display: flex; align-items: center; gap: 8px;">
                    <span>🎯</span> محاور البروتوكول السريري والتأهيلي المقترح:
                </h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 14px;">
                    ${specKeyPoints.map(kp => `
                        <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 14px;">
                            <div style="color: #fef08a; font-weight: bold; font-size: 0.92em; margin-bottom: 6px; display: flex; align-items: center; gap: 8px;">
                                <span>${kp.icon}</span> <span>${kp.title}</span>
                            </div>
                            <div style="color: #cbd5e1; font-size: 0.84em; line-height: 1.6;">
                                ${kp.desc}
                            </div>
                        </div>
                    `).join('')}
            ...
            <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(15, 23, 42, 0.98) 100%); border: 2px solid #10b981; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
                ...
                <h3 style="color: #6ee7b7; margin: 0 0 8px 0; font-size: 1.3em; font-weight: 800;">تنسيق جلسة التقييم والتأهيل السريري المباشر</h3>
                <p style="color: #cbd5e1; font-size: 0.93em; line-height: 1.6; max-width: 650px; margin: 0 auto 20px auto;">
                    لضمان أعلى معايير السلامة واستعادة القدرة الحركية، يرجى إرسال هذا التقرير مباشرة للمعالج <strong>جمال قبها</strong> لترتيب موعد جلسة بالعيادة أو تنسيق <strong>زيارة منزلية متكاملة</strong> للحالات التي يصعب نقلها.
                </p>
                <div style="display: flex; justify-content: center; gap: 12px; flex-wrap: wrap;">
                    <a href="${waUrl}" target="_blank" class="btn-whatsapp-cta" style="display: inline-flex; align-items: center; gap: 10px; padding: 15px 32px; border-radius: 50px; font-size: 1.1em; font-weight: 900; background: linear-gradient(135deg, #25d366 0%, #128c7e 100%); color: #fff; text-decoration: none; box-shadow: 0 6px 25px rgba(37, 211, 102, 0.5); border: 1.5px solid #a7f3d0; cursor: pointer;">
                        <span style="font-size: 1.3em;">💬</span>
                        <span>إرسال التقرير للمعالج جمال قبها عبر واتساب</span>
                        <span>➔</span>
                    </a>
                </div>
                <div style="color: #94a3b8; font-size: 0.85em; margin-top: 14px;">
    ...
    // تمرير الشاشة للأعلى لرؤية التقرير فوراً
    window.scrollTo({ top: 0, behavior: 'smooth' });
}
...
function displayDiagnosticReport(data) {
    ...
    const resolvedReportPhone = (typeof getResolvedPatientPhone === 'function' ? getResolvedPatientPhone() : '') || auth?.originalPhone || auth?.phone || data.patientPhone || '';
    const resolvedReportName = (typeof getResolvedPatientName === 'function' ? getResolvedPatientName() : '') || auth?.fullName || auth?.name || data.patientName || '';
        ...
        <div class="clinical-report-printable" style="background: linear-gradient(135deg, #0d1522 0%, #152238 100%); border-radius: 16px; padding: 32px; border: 1.5px solid var(--primary-gold); box-shadow: 0 12px 40px rgba(0,0,0,0.6); margin-bottom: 30px;">
            ...
            <div id="recovery-plan-master-card" class="recovery-plan-distinct-card no-print" style="padding: 20px 16px; margin-bottom: 25px; background: linear-gradient(135deg, rgba(15, 23, 42, 0.98) 0%, rgba(6, 78, 59, 0.25) 100%); border: 2px solid var(--primary-gold); border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.5);">
                ...
                <div id="plan-activation-btn-wrapper" style="text-align: center; margin: 24px auto 12px auto; max-width: 520px;">
                    ${isRegisteredPatient ? `
                    <div style="margin-bottom: 14px; display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: rgba(16, 185, 129, 0.15); border: 1.5px solid #10b981; padding: 7px 20px; border-radius: 25px; color: #6ee7b7; font-size: 0.92em; font-weight: bold;">
                        <span style="font-size: 1.2em;">👤</span>
                        <span>ملف طبي معتمد: <strong>${resolvedReportName || auth?.name}</strong> (${resolvedReportPhone || auth?.phone})</span>
                ...
                ` : '<div id="plan-registration-inputs" style="display: none !important;"></div>'}
            </div>
...
function revealRegistrationInputs() {
    const auth = (typeof SmartDB !== 'undefined' && typeof SmartDB.getAuthPatient === 'function') ? SmartDB.getAuthPatient() : null;
    if (auth && (auth.isRegistered || auth.phone)) {
        const targetId = auth.patientId || (typeof SmartDB !== 'undefined' && SmartDB.getCurrentSessionPatientId ? SmartDB.getCurrentSessionPatientId() : null) || ('P-' + Date.now().toString().slice(-6));
        showRoyalDuaaModal(targetId);
        return;
    }
...
async function submitPatientRegistrationAndStart() {
    const auth = (typeof SmartDB !== 'undefined' && typeof SmartDB.getAuthPatient === 'function') ? SmartDB.getAuthPatient() : null;
    const name = document.getElementById('sub-name')?.value.trim() || auth?.name || auth?.fullName || '';
    const phone = document.getElementById('sub-phone')?.value.trim() || auth?.phone || '';
    ...
    const curPatient = (typeof activePatient !== 'undefined' && activePatient) || window.activePatient;
    const curAssessment = (typeof currentAssessmentData !== 'undefined' && currentAssessmentData) || window.currentAssessmentData;
    const patientId = auth?.patientId || curPatient?.patientId || curPatient?.id || ('P-' + Date.now().toString().slice(-6));
    ...
    const ageVal = parseInt(document.getElementById('patient-age')?.value) || (typeof curAssessment !== 'undefined' ? curAssessment?.patientVitals?.age : null);
    const weightVal = parseFloat(document.getElementById('patient-weight')?.value) || (typeof curAssessment !== 'undefined' ? curAssessment?.patientVitals?.weight : null);
    const heightVal = parseFloat(document.getElementById('patient-height')?.value) || (typeof curAssessment !== 'undefined' ? curAssessment?.patientVitals?.height : null);
    ...
    let pBmi2 = curAssessment?.bmiInfo?.value || '';
    ...
    const patientObj = {
        ...
        id: patientId,
        name,
        fullName: clinicalDialogueState?.patientFullName || auth?.fullName || name,
        phone: fullPhone,
        gender: patientGender,
        ...
        painAreaTitle: resolvedPainTitle,
        selectedPoint: resolvedPainTitle,
        chiefDiagnosis: curAssessment?.primaryDiagnosis?.title || curAssessment?.title || 'تشخيص سريري متكامل',
        diagnosisTitle: curAssessment?.primaryDiagnosis?.title || curAssessment?.title || 'تشخيص سريري متكامل',
        treatmentPlan: cleanTreatmentPlan,
        assessment: curAssessment,
        latestAssessment: curAssessment,
        notes: cleanNotes,
    ...
    try {
        ...
        console.warn('SmartDB.savePatient warning:', e);
    }
    if (curAssessment) {
        try {
            ...
            console.warn('SmartDB.saveAssessment warning:', e);
        }
    }
    ...
    activePatient = patientObj;
    try {
        localStorage.setItem('smart_patient_phone', fullPhone);
        localStorage.setItem('smart_active_patient', JSON.stringify(patientObj));
        localStorage.setItem('smart_current_patient_id', patientId);
        localStorage.setItem('smart_plan_activated', 'true');
        localStorage.setItem('smart_plan_activated_' + patientId, 'true');
...
async function renderStep4IndependentDay1(patientId, sessionData = null) {
    ...
    // مؤشرات الجلسة الأولى الثلاثة (المقارنة ببيانات الفحص الأولي وتوحيد المنظومة)
    const basePain = Number(sessionData.baselinePain || sessionData.patient?.painLevel || curAssData?.painSeverity || 7);
    const day1Log = (sessionData.dailyLogs || []).find(l => Number(l.sessionNumber || l.day) === 1);
    let s4PainReduction = 0;
    let s4Mobility = 50;
    let s4Sleep = 55;

    if (day1Log) {
        if (typeof day1Log.painScore === 'number' && basePain > 0) {
            s4PainReduction = Math.max(0, Math.min(100, Math.round(((basePain - day1Log.painScore) / basePain) * 100)));
            if (day1Log.painScore < basePain && s4PainReduction === 0) s4PainReduction = 10;
        }
        if (typeof day1Log.mobilityRate === 'number') s4Mobility = day1Log.mobilityRate;
        else if (typeof day1Log.movementScore === 'number') s4Mobility = day1Log.movementScore;
        if (typeof day1Log.sleepRate === 'number') s4Sleep = day1Log.sleepRate;
        ...
        <!-- شريط التنقل الخاص بالإدارة (يظهر فقط للأدمن عند فتح جلسة مريض) -->
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; margin-bottom: 24px;">
                <div style="background: #0f172a; padding: 18px; border-radius: 12px; border: 1px solid rgba(239, 68, 68, 0.3); text-align: center;">
                    <div style="font-size: 2em; font-weight: bold; color: #ef4444;">${s4PainReduction}%</div>
                    <div style="color: #cbd5e1; font-size: 0.88em; font-weight: bold; margin-top: 4px;">مؤشر انخفاض وتلاشي الألم</div>
                    <div style="color: #94a3b8; font-size: 0.75em; margin-top: 2px;">${day1Log ? `مستوى الألم المسجل (${day1Log.painScore}/10) مقارنة بالبداية (${basePain}/10)` : `مقارنة بألم البداية المسجل (${basePain}/10) - يُحدّث بعد التوثيق`}</div>
                </div>

                <div style="background: #0f172a; padding: 18px; border-radius: 12px; border: 1px solid rgba(56, 189, 248, 0.3); text-align: center;">
                    <div style="font-size: 2em; font-weight: bold; color: #38bdf8;">${s4Mobility}%</div>
                    <div style="color: #cbd5e1; font-size: 0.88em; font-weight: bold; margin-top: 4px;">مؤشر استعادة المدى الحركي</div>
                    <div style="color: #94a3b8; font-size: 0.75em; margin-top: 2px;">${day1Log ? `المرونة الموثقة للجلسة الأولى: ${s4Mobility}%` : 'المرونة المقدرة لليوم الأول - تُحدّث بعد التوثيق'}</div>
                </div>

                <div style="background: #0f172a; padding: 18px; border-radius: 12px; border: 1px solid rgba(16, 185, 129, 0.3); text-align: center;">
                    <div style="font-size: 2em; font-weight: bold; color: #10b981;">${s4Sleep}%</div>
                    <div style="color: #cbd5e1; font-size: 0.88em; font-weight: bold; margin-top: 4px;">مؤشر جودة وعمق النوم</div>
                    <div style="color: #94a3b8; font-size: 0.75em; margin-top: 2px;">${day1Log ? `جودة النوم الموثقة: ${s4Sleep}%` : 'جودة النوم الحالية - تُحدّث بعد التوثيق'}</div>
                </div>
            </div>
...
async function renderStep5SessionsDashboard(patientId, targetDay = null, sessionData = null) {
    ...
    let clock24HTML = '';
    const hasExplicitAdminTimingOrUnlock = !lockStatus.isLocked || !!lockStatus.targetTime || !!lockStatus.forced ||
        (localStorage.getItem('force_unlock_global') === 'true') ||
        (localStorage.getItem(`force_unlock_${effectivePid}`) === 'true') ||
        (localStorage.getItem(`custom_target_time_${effectivePid}`) !== null) ||
            ...
            sessionCompletionSectionHTML = `
                <div id="session-completion-control-wrapper" style="text-align: center; margin-top: 25px;">
                    ...
                    <div style="margin-top: 10px; text-align: center;">
                        <button type="button" onclick="handleStep5CompletionClick('${patientId}', ${activeDay}, true)" style="background: none; border: none; color: #94a3b8; font-size: 0.82em; text-decoration: underline; cursor: pointer; padding: 4px 10px; transition: 0.2s;">
                            أديت التمارين مسبقاً خارج الأداة؟ انقر هنا للمتابعة والتوثيق المباشر ❯
                        </button>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 18px;">
                    ${dayExercises.map((ex, idx) => `
                        <div class="clinical-exercise-card" style="background: #0f172a; border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 14px; padding: 20px; display: flex; flex-direction: column; justify-content: space-between;">
                            ...
                            <div>
                                <div style="background: #1e2633; height: 5px; border-radius: 3px; overflow: hidden; margin-bottom: 8px;">
                                    <div class="timer-progress-fill" style="background: linear-gradient(90deg, #d4af37 0%, #10b981 100%); height: 100%; width: ${isDayAlreadyCompleted ? '100%' : '0%'}; transition: width 1s linear;"></div>
                                </div>
                                <div style="display: flex; gap: 8px; align-items: stretch;">
                                    <button type="button" onclick="PatientFlow.toggleExerciseTimer(this, ${ex.durationSec || 30})" class="btn-exercise-timer" data-completed="${isDayAlreadyCompleted ? 'true' : 'false'}" data-running="false" data-remaining="${ex.durationSec || 30}" data-total="${ex.durationSec || 30}" style="flex: 1; background: ${isDayAlreadyCompleted ? '#10b981' : 'linear-gradient(135deg, #d4af37 0%, #aa820a 100%)'}; color: ${isDayAlreadyCompleted ? '#ffffff' : '#0a0e14'}; border: none; padding: 10px 14px; border-radius: 6px; font-weight: bold; cursor: pointer; font-size: 0.92em;">
                                        ${isDayAlreadyCompleted ? '✓ تم إنجاز التمرين بنجاح (انقر للإعادة إن رغبت)' : `⏱️ ابدأ مؤقت التمرين (${ex.duration})`}
                                    </button>
                                    <button type="button" onclick="PatientFlow.markExerciseDone(this)" class="btn-mark-exercise-done" title="تأكيد إنجاز التمرين فوراً دون المؤقت" style="background: ${isDayAlreadyCompleted ? 'rgba(16,185,129,0.2)' : 'rgba(100,116,139,0.15)'}; border: 1px solid ${isDayAlreadyCompleted ? '#10b981' : '#475569'}; color: ${isDayAlreadyCompleted ? '#10b981' : '#94a3b8'}; padding: 0 14px; border-radius: 6px; font-weight: bold; cursor: pointer; font-size: 0.85em; white-space: nowrap; transition: all 0.25s;">
                                        ${isDayAlreadyCompleted ? 'منجز ✓' : 'تم ☑'}
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            if (wrapper) {
                ...
                wrapper.innerHTML = `
                    <div style="text-align: center; margin-top: 25px;">
                        ...
                        <button type="button" onclick="handleStep5CompletionClick('${effectivePid || patientId}', ${activeDay})" class="royal-clinical-next-btn active-unlocked" style="width: 100%; max-width: 620px; margin: 0 auto; background: linear-gradient(180deg, #10b981 0%, #059669 50%, #047857 51%, #065f46 100%) !important; color: #ffffff !important; border: 2px solid #6ee7b7 !important; border-radius: 50px !important; padding: 10px 24px 10px 14px !important; font-size: 1.15em !important; font-weight: 900 !important; letter-spacing: 0.5px; cursor: pointer; display: flex !important; align-items: center !important; justify-content: space-between !important; gap: 14px !important; box-shadow: 0 8px 25px rgba(16, 185, 129, 0.55), inset 0 2px 4px rgba(255, 255, 255, 0.7), 0 2px 4px rgba(0, 0, 0, 0.3) !important; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; text-shadow: 0 1px 3px rgba(0, 0, 0, 0.8) !important; box-sizing: border-box;">
                        ...
                        <div style="margin-top: 10px; text-align: center;">
                            <button type="button" onclick="handleStep5CompletionClick('${effectivePid || patientId}', ${activeDay}, true)" style="background: none; border: none; color: #94a3b8; font-size: 0.82em; text-decoration: underline; cursor: pointer; padding: 4px 10px; transition: 0.2s;">
                                أديت التمارين مسبقاً خارج الأداة؟ انقر هنا للمتابعة والتوثيق المباشر ❯
                            </button>
                        </div>
                    </div>
...
// فحص إتمام كافة تمارين الجلسة (2 إلى 7) قبل فتح نافذة التقييم السريري
function handleStep5CompletionClick(patientId, sessionNumber, forceSkip = false) {
    if (!forceSkip) {
        const step5Box = document.getElementById('step5-sessions-container') || document.getElementById('step-section-5');
        const timerBtns = Array.from((step5Box || document).querySelectorAll('button.btn-exercise-timer'));
        if (timerBtns.length > 0) {
            ...
            if (uncompleted.length > 0) {
                ...
                if (typeof showToast === 'function') {
                    showToast(`⚠️ لا يمكنك توثيق الجلسة (#${sessionNumber}) إلا بعد إتمامك لكافة التمارين المقترحة أدناه (متبقي ${uncompleted.length} تمرين) 🏋️`, 'warning', 4500);
                }
                return;
            }
        }
    ...
    openSessionAssessmentModal(patientId, sessionNumber);
}
window.handleStep5CompletionClick = handleStep5CompletionClick;
...
function goToStep(stepNum, options = {}) {
    ...
    // حفظ الخطوة الحالية فوراً في الذاكرة الدائمة لضمان عدم ضياع أي مرحلة تحت أي ظرف
    try {
        localStorage.setItem('smart_current_step', String(stepNum));
        const curMax = parseInt(localStorage.getItem('smart_max_reached_step') || '1', 10);
        localStorage.setItem('smart_max_reached_step', String(Math.max(curMax, stepNum)));
...
function switchAnatomyView(view) {
    ...
    if (view === 'front') {
        ...
        renderAnatomyPoints('front-anatomy-container', getFrontPoints());
        requestAnimationFrame(() => renderAnatomyPoints('front-anatomy-container', getFrontPoints()));
        setTimeout(() => renderAnatomyPoints('front-anatomy-container', getFrontPoints()), 120);
    } else {
        if (frontCont) {
        ...
        renderAnatomyPoints('back-anatomy-container', getBackPoints());
        requestAnimationFrame(() => renderAnatomyPoints('back-anatomy-container', getBackPoints()));
        setTimeout(() => renderAnatomyPoints('back-anatomy-container', getBackPoints()), 120);
    }
}

// مراقبة ذكية لتحميل أبعاد صور المجسم على الهواتف وإعادة ضبط النقاط فورياً
function initMobileSkeletonObserver() {
    const frontImg = document.querySelector('#front-anatomy-container img');
    const backImg = document.querySelector('#back-anatomy-container img');
    ...
    if (typeof ResizeObserver !== 'undefined') {
        const viewport = document.querySelector('.skeleton-viewport');
        if (viewport && !window._skeletonResizeObserver) {
            let resizeTimer = null;
            window._skeletonResizeObserver = new ResizeObserver(() => {
            ...
            window._skeletonResizeObserver.observe(viewport);
        }
    }
}
window.initMobileSkeletonObserver = initMobileSkeletonObserver;
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // استعادة المرحلة تتم بشكل موثق وآمن بعد التحقق من هوية المريض وقاعدة البيانات
    ...
    switchAnatomyView('front');
    if (typeof initMobileSkeletonObserver === 'function') {
        initMobileSkeletonObserver();
    }
    setTimeout(() => {
        const activeView = document.getElementById('btn-view-back')?.classList.contains('active') ? 'back' : 'front';
        switchAnatomyView(activeView);
    ...
    // ======================================================================
    // استعادة بيانات ومراحل المريض — حفظ دائم وشامل تحت كافة الظروف:
    // 1. البحث عن معرف المريض في الرابط أو الجلسة أو الذاكرة المحلية الدائمة
    // 2. استرجاع نقطة الألم والتقييم السريري والمرحلة التي أنجزها المريض
    // 3. منع أي مسح للبيانات عند التحديث؛ التصفير يتم حصرياً عبر "فحص جديد"
    // ======================================================================
    let savedPatientId = queryPatientId;

    if (!savedPatientId) {
        const authPInit = (typeof SmartDB !== 'undefined' && typeof SmartDB.getAuthPatient === 'function') ? SmartDB.getAuthPatient() : null;
        if (authPInit && (authPInit.patientId || authPInit.id)) {
            savedPatientId = authPInit.patientId || authPInit.id;
        }
    }
    ...
    if (!savedPatientId && typeof SmartDB !== 'undefined' && typeof SmartDB.getCurrentSessionPatientId === 'function') {
        const curId = SmartDB.getCurrentSessionPatientId();
        if (curId) savedPatientId = curId;
    }

    if (savedPatientId) {
        SmartDB.setCurrentSessionPatientId(savedPatientId);
        try {
            sessionStorage.setItem('scp_active_patient_id', savedPatientId);
            localStorage.setItem('smart_current_patient_id', savedPatientId);
            localStorage.setItem('smart_last_active_patient_id', savedPatientId);
        } catch (e) {}
    }

    // استعادة حالة الجلسة الخاصة بالمريض والنقاط
    await restoreActiveSessionState();

    let p = null;
    if (savedPatientId) {
        p = await SmartDB.getPatient(savedPatientId);
        if (!p) {
            try {
                const rawAct = localStorage.getItem('smart_active_patient');
                if (rawAct) {
        ...
        if (p) {
            ...
            // عزل صارم: منع تسرب أي تقرير يخص مريضاً آخر أو جلسة سابقة غير متطابقة
            if (currentAssessmentData && currentAssessmentData.patientId && savedPatientId && currentAssessmentData.patientId !== savedPatientId) {
                currentAssessmentData = null;
                try { localStorage.removeItem('smart_current_assessment'); } catch(e) {}
            }
    ...
    const maxUnlocked = await getMaxUnlockedStep();
    const savedTargetStep = parseInt(localStorage.getItem('smart_current_step') || '0', 10);
    ...
    const effectivePatientId = (queryPatientId ? savedPatientId : (authPatientObj && (authPatientObj.patientId || authPatientObj.id)))
        || savedPatientId 
        || (activePatient && (activePatient.patientId || activePatient.id))
    ...
    // التوجيه الاستدلالي المتقدم مع التحقق الصارم من استحقاق المرحلة للمريض لمنع أي تداخل بين الجلسات
    ...
    // التحقق من أهلية المرحلة المطلوبة للمريض الحالي
    let isTargetStepValid = false;
    if (savedTargetStep === 6) {
        isTargetStepValid = (logs && logs.length >= 7) || (p && p.isPlanCompleted);
    } else if (savedTargetStep === 5) {
        isTargetStepValid = (logs && logs.length >= 1) 
                         || (p && p.currentSessionDay && p.currentSessionDay >= 2) 
                         || (localStorage.getItem(`custom_target_time_${effectivePatientId}`) !== null) 
                         || (localStorage.getItem(`force_unlock_${effectivePatientId}`) !== null)
                         || (localStorage.getItem('custom_target_time_global') !== null)
                         || (parseInt(localStorage.getItem('smart_max_reached_step') || '0', 10) >= 5);
    } else if (savedTargetStep === 4) {
        isTargetStepValid = isPlanActive 
                         || maxUnlocked >= 4 
                         || (parseInt(localStorage.getItem('smart_max_reached_step') || '0', 10) >= 4)
                         || (currentAssessmentData && (!currentAssessmentData.patientId || currentAssessmentData.patientId === effectivePatientId));
    } else if (savedTargetStep === 3) {
        isTargetStepValid = !!currentAssessmentData && (!currentAssessmentData.patientId || currentAssessmentData.patientId === effectivePatientId);
    } else if (savedTargetStep === 2) {
        isTargetStepValid = !!currentSelectedPoint;
    }

    // توجيه صارم وموثوق للمراحل المعتمدة فقط
    ...
    if (logs && logs.length >= 7 || savedTargetStep === 6) {
        goToStep(6);
        await loadPatientRecoveryDashboard(effectivePatientId);
        return;
    } else if ((logs && logs.length >= 1) || (p && p.currentSessionDay && p.currentSessionDay >= 2) || savedTargetStep === 5) {
        goToStep(5);
        await loadPatientRecoveryDashboard(effectivePatientId, logs.length ? Math.min(7, logs.length + 1) : 2);
        return;
    } else if (isPlanActive || maxUnlocked >= 4 || savedTargetStep === 4) {
        await renderStep4IndependentDay1(effectivePatientId);
        return;
...
async function sendChatMessage() {
    ...
    if (isExpectingPhone) {
        ...
        if (validFoundPhone) {
            ...
            const pGender = pVitals.gender || (typeof detectArabicGender === 'function' ? detectArabicGender(savedName) : 'ذكر');
            ...
            if (activeSpec) {
                ...
                if (typeof Wada3anAiEngine !== 'undefined') {
                    Wada3anAiEngine.stopSpeaking();
                    const closingVoice = `شكراً لك يا ${savedName}. لقد تم توثيق بيانات حالتك واعتمادها بنجاح. نقوم الآن بتحويلك مباشرة لصفحة التقرير والتحويل السريري للتواصل مع المعالج جمال قبها عبر الواتساب. نسأل الله لك دوام الصحة والعافية.`;
                    Wada3anAiEngine.speakDoctorResponse(closingVoice);
                }

                let transitionedSpec = false;
                ...
                window.doDirectTransitionToSpecializedReport = doSpecTransition;
